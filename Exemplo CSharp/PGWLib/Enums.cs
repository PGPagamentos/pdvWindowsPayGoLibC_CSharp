...
namespace PGWLib
{
	public class Enums
	{
		...
		public enum E_PWPPEVTIN : uint
		{
			...
			PWPPEVTIN_ICCOUT	= 16	// Remoção de crtão com chip
		}
		...
		public enum E_PWTypeInput : byte
		{

			TYPED_NUMERIC = 1,
			TYPED_ALPHA = 2,
			TYPED_ALPHANUMERIC = 3,
			TYPED_ALPHANUMERICSP = 7
		...
		public enum E_PWAutCapabilities : int
		{
			TROCO          = 1,     /* funcionalidade de troco/saque */
			DESCONTO       = 2,     /* funcionalidade de desconto */
			FIXO           = 4,     /* valor fixo, sempre incluir */
			CUPOMDIF       = 8,     /* impressão das vias diferenciadas do comprovante para Cliente/Estabelecimento */
